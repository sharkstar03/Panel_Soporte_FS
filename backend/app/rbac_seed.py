...
def seed_rbac(db: Session) -> None:
    defaults: list[tuple[str, str, str]] = [
        ...
        ("assets.reveal", "assets", "Revelar credenciales de acceso remoto"),
        ...
        ("documents.update", "documents", "Editar documentos (solo pendientes)"),
        ("documents.delete", "documents", "Eliminar documentos"),
        ("documents.approve", "documents", "Aprobar/rechazar documentos"),
        ("documents.templates.manage", "documents", "Administrar plantillas HTML de documentos"),
    ...
    role_perms: dict[str, set[str]] = {
        ...
        "supervisor": {
            ...
            "documents.view", "documents.create", "documents.update", "documents.delete", "documents.approve",
